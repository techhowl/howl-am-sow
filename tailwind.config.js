  ...
  theme: {
    extend: {
      animation: {
        ...
        // Adding to existing animations
        "shimmer": "shimmer 1.5s infinite",
        "float-gentle": "float-gentle 4s var(--ease-glass) infinite",
        "rise": "rise 0.5s var(--ease-glass) both",
        "aurora-drift": "aurora-drift 26s var(--ease-glass) infinite alternate",
        "theme-reveal": "theme-reveal 0.5s var(--ease-reveal)",
      },
      keyframes: {
        "background-gradient": {
          "0%, 100%": {
